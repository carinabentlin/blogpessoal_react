        ...
        <div className='container flex flex-col mx-auto items-center text-black'>
            ...
            >
                <div className='flex flex-col gap-2'>
                    <label htmlFor="titulo" className='text-black'>Título da Postagem</label>
                    <input
                        type="text"
                        placeholder="Título"
                        name="titulo"
                ...
                <div className='flex flex-col gap-2'>
                    <label htmlFor="texto" className='text-black'>Texto da Postagem</label>
                    <input
                        type="text"
                        placeholder="Texto"
                        name="texto"
                ...
                <div className='flex flex-col gap-2'>
                    <p className='text-black'>Tema da Postagem</p>
                    <select
                        name="tema"
                        id="tema"
